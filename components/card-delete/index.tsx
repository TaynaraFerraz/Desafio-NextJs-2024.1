...
export default function CardDelete({dados}:{dados: number}){
    return(
        ...
        <div className="bg-white h-96 border-2 rounded-xl w-[520px] flex flex-col justify-center items-center gap-16" id="modal">
            ...
            <button className="bg-red-500 text-white text-2xl p-4 rounded-xl" onClick={() => deletarMembro(dados)}>Excluir</button>
        </div>
    </div>
    )
}